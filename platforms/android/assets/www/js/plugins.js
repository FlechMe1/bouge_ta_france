...
var ImgCache = {
    ...
    jQuery: (window.jQuery || window.Zepto) ? true : false,
    /* using jQuery if it's available otherwise the DOM API */
    jQueryLite: (typeof window.angular !== 'undefined' && window.angular.element) ? true : false,
...
(function($) {
  ...
  Private.createCacheDir = function(success_callback, error_callback) {
    ...
    ImgCache.attributes.filesystem.root.getDirectory(ImgCache.options.localCacheFolder, {
      create: true,
      exclusive: false
  ...
  Private.loadCachedFile = function($element, img_src, set_path_callback, success_callback, error_callback) {
    ...
    ImgCache.attributes.filesystem.root.getFile(Private.getCachedFilePath(img_src), {
      create: false
    }, _gotFileEntry, _fail);
  };
  ...
  ImgCache.removeFile = function(img_src, success_callback, error_callback) {
    ...
    ImgCache.attributes.filesystem.root.getFile(filePath, {
      create: false
    }, function(fileEntry) {
      fileEntry.remove(
        function() {
            ...
            function(m, n, o) {
              ...
              function u(a) {
                ...
                angular.forEach(q(), function(a, c) {
                  a.style.cssText = i(h(c, b, I.transitionType))
                })
              }

              function v(a, b) {
                if (void 0 === a && (a = m.carouselIndex), b = b || {}, b.animate === !1 || "none" === I.transitionType) return O = !1, K = -100 * a, m.carouselIndex = a, B(), void 0;
                O = !0;
                var c = new j;
                c.tween({
                  from: {
                  ...
                  finish: function() {
                    O = !1, m.$apply(function() {
                      m.carouselIndex = a, K = -100 * a, B()
                    })
                  }
                })
              }
              ...
              function y(a) {
                return c.bind("mouseup", r), x(), N = n[0].querySelector("li").getBoundingClientRect().left, D = !0, E = a.x, !1
              }

              function z(a) {
                if (!O) {
                  var b, c;
                  if (D && (b = a.x, c = E - b, c > 2 || -2 > c)) {
                    L = !0;
                    var d = K + 100 * -c / M;
                    u(d)
                  }
              ...
              function A(a, b) {
                if ((!b || L) && (c.unbind("mouseup", r), D = !1, L = !1, F = E - a.x, 0 !== F && !O))
                  if (K += 100 * -F / M, I.isSequential) {
                    var d = I.moveTreshold * M,
                      e = -F,
                      f = -Math[e >= 0 ? "ceil" : "floor"](e / M),
                      g = Math.abs(e) > d;
                    G && f + m.carouselIndex >= G.length && (f = G.length - 1 - m.carouselIndex), f + m.carouselIndex < 0 && (f = -m.carouselIndex);
                    var h = g ? f : 0;
                    F = m.carouselIndex + h, v(F)
                  } else m.$apply(function() {
                    m.carouselIndex = parseInt(-K / 100, 10), B()
                  })
              }
              ...
              function B() {
                ...
                t ? (a = m.carouselIndex <= b ? 0 : G && G.length < m.carouselBufferSize ? 0 : G && m.carouselIndex > G.length - m.carouselBufferSize ? G.length - m.carouselBufferSize : m.carouselIndex - b, m.carouselBufferIndex = a, f(function() {
                  u(K)
                }, 0, !1)) : f(function() {
                  u(K)
                }, 0, !1)
              ...
              a.bind(n, {
                ...
                b > G.length - 1 && (b = 0), O || v(b, a)
              }, m.prevSlide = function(a) {
                var b = m.carouselIndex - 1;
                0 > b && (b = G.length - 1), v(b, a)
              };
              var Q = !0;
              m.carouselIndex = 0, s || (G = [], angular.forEach(q(), function(a, b) {
                G.push({
                  id: b
                })
              }));
              ...
              if (void 0 !== o.rnCarouselAutoSlide) {
                var S = parseInt(o.rnCarouselAutoSlide, 10) || I.autoSlideDuration;
                R = g(function() {
                  O || D || m.nextSlide()
                }, 1e3 * S)
              }
              if (o.rnCarouselIndex) {
                var T = function(a) {
                  ...
                  U = d(o.rnCarouselIndex);
                angular.isFunction(U.assign) ? (m.$watch("carouselIndex", function(a) {
                  O || T(a)
                }), m.$parent.$watch(U, function(a) {
                  void 0 !== a && null !== a && (G && a >= G.length ? (a = G.length - 1, T(a)) : G && 0 > a && (a = 0, T(a)), O || v(a, {
                    animate: !Q
                  }), Q = !1)
                }), J = !0) : isNaN(o.rnCarouselIndex) || v(parseInt(o.rnCarouselIndex, 10), {
                  animate: !1
                })
              } else v(0, {
                animate: !Q
              ...
              if (o.rnCarouselLocked && m.$watch(o.rnCarouselLocked, function(a) {
                ...
                var V = void 0 !== o.rnCarouselDeepWatch;
                m[V ? "$watch" : "$watchCollection"](p, function(a, b) {
                  (G || a).slice();
                  if (G = a, V && angular.isArray(a)) {
                    var c = b[m.carouselIndex],
                      d = k(a, c, m.carouselIndex);
                    v(d, {
                      animate: !1
                    })
                  } else v(m.carouselIndex, {
                    animate: !1
                  })
                }, !0)
              }
              m.$on("$destroy", function() {
                c.unbind("mouseup", r)
              }), m.carouselBufferIndex = 0, m.carouselBufferSize = I.bufferSize;
              var W = angular.element(b);
              W.bind("orientationchange", C), W.bind("resize", C), m.$on("$destroy", function() {
                c.unbind("mouseup", r), W.unbind("orientationchange", C), W.unbind("resize", C)
              })
            }
        }
      }
...
ngMap.service("Attr2Options", ["$parse", "NavigatorGeolocation", "GeoCoder", function($parse, NavigatorGeolocation, GeoCoder) {
  var SPECIAL_CHARS_REGEXP = /([\:\-\_]+(.))/g,
    ...
    camelCase = function(e) {
      return e.replace(SPECIAL_CHARS_REGEXP, function(e, t, n, r) {
    ...
    setDelayedGeoLocation = function(e, t, n, r) {
      r = r || {};
      var a = e.centered || r.centered,
        o = function() {
          var n = r.fallbackLocation || new google.maps.LatLng(0, 0);
          e[t](n)
        };
      !n || n.match(/^current/i) ? NavigatorGeolocation.getCurrentPosition().then(function(n) {
        var r = n.coords.latitude,
          o = n.coords.longitude,
          i = new google.maps.LatLng(r, o);
        e[t](i), a && e.map.setCenter(i)
      }, o) : GeoCoder.geocode({
        address: n
      }).then(function(n) {
        e[t](n[0].geometry.location), a && e.map.setCenter(n[0].geometry.location)
      }, o)
    },
    getAttrsToObserve = function(e) {
      ...
      if (e["ng-repeat"] || e.ngRepeat);
        ...
        for (var n in e) {
          var r = e[n];
          r && r.match(/\{\{.*\}\}/) && t.push(camelCase(n))
        }
      return t
    },
    observeAttrSetObj = function(e, t, n) {
      var r = getAttrsToObserve(e);
      Object.keys(r).length;
      for (var a = 0; a < r.length; a++) observeAndSet(t, r[a], n)
    },
    observeAndSet = function(e, t, n) {
      e.$observe(t, function(e) {
        if (e) {
          var r = camelCase("set-" + t),
            a = toOptionValue(e, {
              key: t
            });
          n[r] && (t.match(/center|position/) && "string" == typeof a ? setDelayedGeoLocation(n, r, a) : n[r](a))
        }
      })
    };
  return {
      ...
      var n = {},
        ...
        a = function(t) {
          var n = t.match(/([^\(]+)\(([^\)]*)\)/),
            ...
            o = e.$eval("[" + a + "]");
          return function(t) {
            e[r].apply(this, [t].concat(o)), e.$apply()
          }
        };
      for (var o in t)
        if (t[o]) {
          ...
          var i = o.replace(/^on/, "");
          i = i.charAt(0).toLowerCase() + i.slice(1), i = i.replace(/([A-Z])/g, r);
          var s = t[o];
          n[i] = new a(s)
        }
      return n
            ...
            for (var i in o)
              if (o[i]) {
                ...
                if ("string" == typeof s ? s = s.toUpperCase() : "mapTypeIds" === i && (s = s.map(function(e) {
                  ...
                  o[i] = google.maps[c][s]
                } else o[i] = "position" === i ? google.maps.ControlPosition[s] : s
              }
            t[n] = o
          } catch (l) {}
        }
...
}]), ngMap.service("GeoCoder", ["$q", function(e) {
  return {
    geocode: function(t) {
      var n = e.defer(),
...
}]), ngMap.service("NavigatorGeolocation", ["$q", function(e) {
  return {
...
}]), ngMap.service("StreetView", ["$q", function(e) {
  return {
    getPanorama: function(t, n) {
      ...
      return a.getPanoramaByLocation(n || t.getCenter, 100, function(e, t) {
        t === google.maps.StreetViewStatus.OK ? r.resolve(e.location.pano) : r.resolve(!1)
      }), r.promise
    },
  ...
  var t = e,
    n = function(e, t) {
      ...
      for (var r in t) google.maps.event.addListener(n, r, t[r]);
      return n
    };
  return {
    restrict: "E",
    require: "^map",
    link: function(e, r, a, o) {
      var i = t.orgAttributes(r),
        s = t.filter(a),
        p = t.getOptions(s),
        c = t.getEvents(e, s),
        l = n(p, c);
      o.addObject("bicyclingLayers", l), t.observeAttrSetObj(i, a, l)
    }
  }
  ...
  return {
    ...
    link: function(e, r, a, o) {
      var i = t.orgAttributes(r),
        ...
        c = t.getEvents(e, s),
        l = n(p, c);
      o.addObject("cloudLayers", l), t.observeAttrSetObj(i, a, l)
    }
  }
  ...
  return {
    ...
    link: function(e, r, a, o) {
      r.css("display", "none");
      var i = (n.orgAttributes(r), n.filter(a)),
        s = n.getOptions(i, e),
        p = n.getEvents(e, i),
        c = t(r.html().trim())(e),
        l = c[0];
      for (var u in p) google.maps.event.addDomListener(l, u, p[u]);
      o.addObject("customControls", l), e.$on("mapInitialized", function(e, t) {
        var n = s.position;
  ...
  return {
    ...
    link: function(e, r, a, o) {
      ...
      o.addObject("heatmapLayers", p)
    }
  }
}]), ngMap.directive("infoWindow", ["Attr2Options", "$compile", function(e, t) {
  var n = e,
    r = function(e, t) {
      var r;
      if (e.position instanceof google.maps.LatLng) r = new google.maps.InfoWindow(e);
      else {
        var a = e.position;
        e.position = new google.maps.LatLng(0, 0), r = new google.maps.InfoWindow(e), n.setDelayedGeoLocation(r, "setPosition", a)
      }
      Object.keys(t).length > 0;
      for (var o in t) o && google.maps.event.addListener(r, o, t[o]);
      return r
    };
  return {
    restrict: "E",
    ...
    link: function(e, a, o, i) {
      a.css("display", "none");
      var s = n.orgAttributes(a),
        p = n.filter(o),
        c = n.getOptions(p, e),
        l = n.getEvents(e, p),
        u = a.html().trim();
      if (1 != angular.element(u).length) throw "info-window working as a template must have a container";
      var g = r(c, l);
      g.template = u.replace(/ng-non-/, ""), i.addObject("infoWindows", g), n.observeAttrSetObj(s, o, g), e.showInfoWindow = e.showInfoWindow || function(t, n, r) {
        var a = i.map.infoWindows[n],
          o = a.template.trim(),
          s = o.replace(/{{([^}]+)}}/g, function(t, n) {
            return e.$eval(n)
          });
        a.setContent(s), r ? (a.setPosition(r), a.open(i.map)) : this.getPosition ? a.open(i.map, this) : a.open(i.map)
      }, g.visible && e.$on("mapInitialized", function() {
        var n = t(g.template)(e);
        g.setContent(n.html()), g.open(i.map)
      }), g.visibleOnMarker && e.$on("mapInitialized", function() {
        var n = i.map.markers[g.visibleOnMarker];
        if (!n) throw "Invalid marker id";
        var r = t(g.template)(e);
        g.setContent(r.html()), g.open(i.map, n)
      })
    }
  }
  ...
  return {
    ...
    link: function(e, r, a, o) {
      var i = t.orgAttributes(r),
        ...
        c = t.getEvents(e, s),
        l = n(p, c);
      o.addObject("kmlLayers", l), t.observeAttrSetObj(i, a, l)
    }
  }
    ...
    link: function(e, n, r) {
      ...
      e.$on("mapInitialized", function(t, n) {
        for (var r in o)
          if (r) {
            var a = o[r];
            "function" == typeof e[a] ? n.data[r](e[a]) : n.data[r](a)
          }
        for (var s in i) i[s] && n.data.addListener(s, i[s])
      })
    }
  }
  ...
  return {
    ...
    link: function(e, n, r, a) {
      var o, i = r.name;
      if (!i) throw "invalid map-type name";
      if (r.object) {
        var s = e[r.object] ? e : t;
        o = s[r.object], "function" == typeof o && (o = new o)
      }
      if (!o) throw "invalid map-type object";
      e.$on("mapInitialized", function(e, t) {
        t.mapTypes.set(i, o)
      }), a.addObject("mapTypes", o)
    }
  }
  ...
  return {
    ...
    link: function(a, o, i, s) {
      var p = r.orgAttributes(o);
      a.google = google;
      var c = document.createElement("div");
      c.style.width = "100%", c.style.height = "100%", o.prepend(c), "block" != n(o[0], "display") && o.css("display", "block"), n(o[0], "height").match(/^0/) && o.css("height", "300px");
      var l = function(n, o) {
          var l = new google.maps.Map(c, {});
          l.markers = {}, l.shapes = {}, t(function() {
            google.maps.event.trigger(l, "resize")
          }), n.zoom = n.zoom || 15;
          var u = n.center;
          u instanceof google.maps.LatLng || (delete n.center, e.setDelayedGeoLocation(l, "setCenter", u, g.geoFallbackCenter)), l.setOptions(n);
          for (var m in o) m && google.maps.event.addListener(l, m, o[m]);
          r.observeAttrSetObj(p, i, l), s.map = l, s.addObjects(s._objects), a.map = l, a.map.scope = a, a.$emit("mapInitialized", l), a.maps = a.maps || {}, a.maps[g.id || Object.keys(a.maps).length] = l, a.$emit("mapsInitialized", a.maps)
        },
        u = r.filter(i),
        g = r.getOptions(u, a),
        m = r.getControlOptions(u),
        v = angular.extend(g, m),
        f = r.getEvents(a, u);
      i.initEvent ? a.$on(i.initEvent, function() {
        !s.map && l(v, f)
      }) : l(v, f)
    }
  }
}]), ngMap.MapController = function() {
  this.map = null, this._objects = [], this.addMarker = function(e) {
    if (this.map) {
      this.map.markers = this.map.markers || {}, e.setMap(this.map), e.centered && this.map.setCenter(e.position);
      var t = Object.keys(this.map.markers).length;
      this.map.markers[e.id || t] = e
    } else this._objects.push(e)
  }, this.addShape = function(e) {
    if (this.map) {
      this.map.shapes = this.map.shapes || {}, e.setMap(this.map);
      var t = Object.keys(this.map.shapes).length;
      this.map.shapes[e.id || t] = e
    } else this._objects.push(e)
  }, this.addObject = function(e, t) {
    if (this.map) {
      this.map[e] = this.map[e] || {};
      var n = Object.keys(this.map[e]).length;
      this.map[e][t.id || n] = t, "infoWindows" != e && t.setMap && t.setMap(this.map)
    } else t.groupName = e, this._objects.push(t)
  }, this.addObjects = function(e) {
    for (var t = 0; t < e.length; t++) {
      var n = e[t];
      n instanceof google.maps.Marker ? this.addMarker(n) : n instanceof google.maps.Circle || n instanceof google.maps.Polygon || n instanceof google.maps.Polyline || n instanceof google.maps.Rectangle || n instanceof google.maps.GroundOverlay ? this.addShape(n) : this.addObject(n.groupName, n)
    }
  }
  ...
  var t = e,
    n = function(e, n) {
      ...
      if (e.icon instanceof Object) {
        ...
        for (var a in e.icon) {
          var o = e.icon[a];
          "anchor" == a || "origin" == a ? e.icon[a] = new google.maps.Point(o[0], o[1]) : ("size" == a || "scaledSize" == a) && (e.icon[a] = new google.maps.Size(o[0], o[1]))
        }
      }
      if (e.position instanceof google.maps.LatLng) r = new google.maps.Marker(e);
      else {
        var i = e.position;
        e.position = new google.maps.LatLng(0, 0), r = new google.maps.Marker(e), t.setDelayedGeoLocation(r, "setPosition", i)
      }
      Object.keys(n).length > 0;
      for (var s in n) s && google.maps.event.addListener(r, s, n[s]);
      return r
    };
  return {
    restrict: "E",
    ...
    link: function(e, r, a, o) {
      ...
      r.bind("$destroy", function() {
        var e = l.map.markers;
        for (var t in e) e[t] == l && delete e[t];
        l.setMap(null)
      });
      var l = n(p, c);
      o.addMarker(l), t.observeAttrSetObj(i, a, l)
    }
  }
  ...
  return {
    ...
    link: function(e, n, r, a) {
      ...
      e.$on("mapInitialized", function(e, t) {
        if ("insertAt" == i) {
          var n = parseInt(r.index, 10);
          t.overlayMapTypes.insertAt(n, o)
        } else "push" == i && t.overlayMapTypes.push(o)
      }), a.addObject("overlayMapTypes", o)
    }
  }
  ...
  var t = e,
    ...
    r = function(e, r) {
      ...
      switch (o) {
        case "circle":
          if (e.center instanceof google.maps.LatLng) a = new google.maps.Circle(e);
          else {
            var p = e.center;
            e.center = new google.maps.LatLng(0, 0), a = new google.maps.Circle(e), t.setDelayedGeoLocation(a, "setCenter", p)
          }
          break;
        case "polygon":
          a = new google.maps.Polygon(e);
          break;
        case "polyline":
          a = new google.maps.Polyline(e);
          break;
        case "rectangle":
          e.bounds && (e.bounds = n(e.bounds)), a = new google.maps.Rectangle(e);
          break;
        case "groundOverlay":
        case "image":
          var c = e.url,
          ...
          a = new google.maps.GroundOverlay(c, l, u)
      }
      for (var g in r) r[g] && google.maps.event.addListener(a, g, r[g]);
      return a
    };
  return {
    restrict: "E",
    ...
    link: function(e, n, a, o) {
      var i = t.orgAttributes(n),
        s = t.filter(a),
        p = t.getOptions(s),
        c = t.getEvents(e, s),
        l = r(p, c);
      o.addShape(l), t.observeAttrSetObj(i, a, l)
    }
  }
  ...
  return {
    ...
    link: function(e, r, a, o) {
      var i = t.orgAttributes(r),
        ...
        c = t.getEvents(e, s),
        l = n(p, c);
      o.addObject("trafficLayers", l), t.observeAttrSetObj(i, a, l)
    }
  }
  ...
  return {
    ...
    link: function(e, r, a, o) {
      var i = t.orgAttributes(r),
        ...
        c = t.getEvents(e, s),
        l = n(p, c);
      o.addObject("transitLayers", l), t.observeAttrSetObj(i, a, l)
    }
  }
  ...
  return {
    ...
    link: function(e, r, a, o) {
      var i = t.orgAttributes(r),
        ...
        c = t.getEvents(e, s),
        l = n(p, c);
      o.addObject("weatherLayers", l), t.observeAttrSetObj(i, a, l)
    }
  }
}]);
